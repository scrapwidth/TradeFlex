...
namespace TradeFlex.IntegrationTest;
...
class Program
{
    ...
    {
        Console.WriteLine("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
        Console.WriteLine("  Alpaca Integration Test");
        Console.WriteLine("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
        Console.WriteLine();
        ...
        try
        {
            ...
            // Step 6: Test Order Submission (Buy fractional BTC)
            Console.WriteLine("Step 6: Testing order submission (Buy 0.001 BTC)...");
            try
            {
                var order = new TradeFlex.Abstractions.Order("BTC/USD", 0.001m, 0);
                
                Console.WriteLine("  Submitting market buy order...");
                ...
                var newPosition = broker.GetPosition("SPY");
                Console.WriteLine($"  ✓ New SPY position: {newPosition:F8}");
            }
            catch (Exception ex)
            {
                Console.WriteLine($"  ❌ Failed to submit order: {ex.Message}");
            ...
            Console.WriteLine("     ./run-shadow.sh alpaca");
            Console.WriteLine();
